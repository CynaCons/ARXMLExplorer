...
class XsdParser {
  ...
  Map<String, SchemaElementInfo>? _builtElementIndex; // added
  ...
  // Build (or return cached) map of element name -> SchemaElementInfo (children + attributes)
...
// Simple DTO for schema element info (children + attributes)
